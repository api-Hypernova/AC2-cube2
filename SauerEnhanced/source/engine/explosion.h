...
static fireballrenderer fireballs("packages/particles/explosion.png"), bluefireballs("packages/particles/plasma.png"), plasmafireballs("packages/particles/plasma2.png");
