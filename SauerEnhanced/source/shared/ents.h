...
struct physent                                  // base entity type, can be affected by physics
{
    ...
    float lastvelx, lastvely; //used for compensating for air friction in x/y
    ...
    physent() : o(0, 0, 0), deltapos(0, 0, 0), newpos(0, 0, 0), yaw(0), pitch(0), roll(0), maxspeed(100),
               radius(4.1f), eyeheight(16), aboveeye(1), xradius(4.1f), yradius(4.1f), zmargin(0),
...
enum
{
    ...
    ANIM_HOLD1, ANIM_HOLD2, ANIM_HOLD3, ANIM_HOLD4, ANIM_HOLD5, ANIM_HOLD6, ANIM_HOLD7, ANIM_HOLD8, ANIM_HOLD9, ANIM_HOLD10, ANIM_HOLD11, ANIM_HOLD12, ANIM_HOLD13, ANIM_HOLD14, ANIM_HOLD15, ANIM_HOLD16,
    ANIM_ATTACK1, ANIM_ATTACK2, ANIM_ATTACK3, ANIM_ATTACK4, ANIM_ATTACK5, ANIM_ATTACK6, ANIM_ATTACK7, ANIM_ATTACK8, ANIM_ATTACK9, ANIM_ATTACK10, ANIM_ATTACK11, ANIM_ATTACK12, ANIM_ATTACK13, ANIM_ATTACK14, ANIM_ATTACK15, ANIM_ATTACK16,
    ANIM_PAIN,
...
static const char * const animnames[] =
{
    ...
    "hold 1", "hold 2", "hold 3", "hold 4", "hold 5", "hold 6", "hold 7", "hold 8", "hold 9", "hold 10", "hold 11", "hold 12", "hold 13", "hold 14", "hold 15", "hold 16",
    "attack 1", "attack 2", "attack 3", "attack 4", "attack 5", "attack 6", "attack 7", "attack 8", "attack 9", "attack 10", "attack 11", "attack 12", "attack 13", "attack 14", "attack 15", "attack 16",
    "pain",
    "jump", "sink", "swim",
