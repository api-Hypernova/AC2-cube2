...
{
    { S_LASER,   -1, 0,  10000,  5, 0,   0,   0, 75,  1, 1024,  200, 0, 0,    0, 0, 0, "blaster", "laser"  },
    { S_SHOTGUN2,  -1, 6, 1500,  15, 150, 0,   0, 20, 12,1024, 200, 0, 0,    0, 0, 2, "*",         "solaris_shotgun" }, //shotgdefault
    { S_PULSERIFLE, -1, 45, 100,  90, 0,  0,   0, 7,  1, 1024, 150, 0, 0,    0, 0, 1,  "}",        "pyccna_m4a1"},
    ...
    { S_UZI,       -1, 30, 200,   75,  0,  0,   0, 3,  1, 1024, 150, 0, 0,    0, 0, 1, "&",  "ak74"},
    ...
    { S_PISTOL,    -1, 18, 200, 50, 0,  0,   0, 8,  1, 1024, 150, 0, 0,    0, 0, 1, "%",          "pyccna_fn57" },
