...
namespace game
{
    ...
    static const monstertype monstertypes[NUMMONSTERTYPES] =
    {
        ...
        { GUN_MAGNUM,     14, 200, 1, 80,  400, 300, 4, 18, 145, S_PAINS, S_DEATHS, "a slith",     "monster/slith",      "monster/slith/vwep"},
        ...
        { GUN_HANDGRENADE,        22,  50, 1, 0,   200, 400, 1, 10,  40, S_PAIND, S_DEATHD, "a spider",    "monster/spider",      NULL },
    };
                    ...
                    if(trigger<lastmillis)
                    {
                        ...
                        else 
                        {
                            ...
                            switch(monstertypes[mtype].gun)
                            {
                                ...
                                case GUN_MAGNUM: longrange = true; break;
                            }
